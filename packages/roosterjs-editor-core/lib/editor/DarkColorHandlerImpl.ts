...
import { ColorManager, getObjectKeys } from 'roosterjs-editor-dom';
...
export default class DarkColorHandlerImpl extends ColorManager implements DarkColorHandler {
    ...
    constructor(
        private getDarkColor: (color: string, baseLValue?: number) => string,
        private contentDiv?: HTMLElement,
        isDarkMode: boolean = false,
        private knownColors: Record<string, Readonly<ModeIndependentColor>> = {},
        private baseLValue: number = DefaultBaseLValue,
